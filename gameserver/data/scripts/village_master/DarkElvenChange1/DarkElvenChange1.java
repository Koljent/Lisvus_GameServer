...
public class DarkElvenChange1 extends Quest
{
	...
	static
	{
		CLASSES.put("PK", new ClassChangeData(ClassId.palusKnight, ClassId.darkFighter, Race.DarkElf, new String[]
		{
			"15",
			"16",
			"17",
		...
		CLASSES.put("AS", new ClassChangeData(ClassId.assassin, ClassId.darkFighter, Race.DarkElf, new String[]
		{
			"19",
			"20",
			"21",
		...
		CLASSES.put("DW", new ClassChangeData(ClassId.darkWizard, ClassId.darkMage, Race.DarkElf, new String[]
		{
			"23",
			"24",
			"25",
		...
		CLASSES.put("SO", new ClassChangeData(ClassId.shillienOracle, ClassId.darkMage, Race.DarkElf, new String[]
		{
			"27",
			"28",
			"29",
