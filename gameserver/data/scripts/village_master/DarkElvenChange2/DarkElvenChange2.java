...
public class DarkElvenChange2 extends Quest
{
	...
	static
	{
		CLASSES.put("SK", new ClassChangeData(ClassId.shillienKnight, ClassId.palusKnight, Race.DarkElf, new String[]
		{
			"26",
			"27",
			"28",
		...
		CLASSES.put("BD", new ClassChangeData(ClassId.bladedancer, ClassId.palusKnight, Race.DarkElf, new String[]
		{
			"30",
			"31",
			"32",
		...
		CLASSES.put("SE", new ClassChangeData(ClassId.shillienElder, ClassId.shillienOracle, Race.DarkElf, new String[]
		{
			"34",
			"35",
			"36",
		...
		CLASSES.put("AW", new ClassChangeData(ClassId.abyssWalker, ClassId.assassin, Race.DarkElf, new String[]
		{
			"38",
			"39",
			"40",
		...
		CLASSES.put("PR", new ClassChangeData(ClassId.phantomRanger, ClassId.assassin, Race.DarkElf, new String[]
		{
			"42",
			"43",
			"44",
		...
		CLASSES.put("SH", new ClassChangeData(ClassId.spellhowler, ClassId.darkWizard, Race.DarkElf, new String[]
		{
			"46",
			"47",
			"48",
		...
		CLASSES.put("PS", new ClassChangeData(ClassId.phantomSummoner, ClassId.darkWizard, Race.DarkElf, new String[]
		{
			"50",
			"51",
			"52",
