 ...
 */
package village_master.ReedOccupationChange;
...
public class ReedOccupationChange extends Quest
{
	...
	{
		super(-1, ReedOccupationChange.class.getSimpleName(), "village_master");
	...
	public String onEvent(String event, QuestState st)
	{
		...
		for (int i = 1; i <= 4; i++)
		{
			if (event.equalsIgnoreCase("7520-0" + i + ".htm"))
			{
				return event;
			}
		}
