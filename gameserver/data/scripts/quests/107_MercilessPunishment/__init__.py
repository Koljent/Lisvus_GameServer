...
class Quest (JQuest) :
 ...
 def onTalk (self,npc,st):
    ...
    elif npcId == 7568 and id == State.CREATED :
    ...
    elif npcId == 7568 and st.getInt("cond")==1 and (st.getQuestItemsCount(HATOSS_ORDER1_ID) or st.getQuestItemsCount(HATOSS_ORDER2_ID) or st.getQuestItemsCount(HATOSS_ORDER3_ID)) and ((st.getQuestItemsCount(LETTER_TO_ELF_ID)+st.getQuestItemsCount(LETTER_TO_HUMAN_ID)+st.getQuestItemsCount(LETTER_TO_DARKELF_ID))==3) :
        if st.getInt("id") != 107 :
            st.set("id","107")
            ...
            if qs :
               ...
               if newbiegift != 2 and st.getPlayer().isNewbie() :
                  ...
                  qs.set("newbiegift","2")
	elif npcId == 7580 and st.getInt("cond")==1 and id == State.STARTED and (st.getQuestItemsCount(HATOSS_ORDER1_ID) or st.getQuestItemsCount(HATOSS_ORDER2_ID) or st.getQuestItemsCount(HATOSS_ORDER3_ID)) :
